...
-lambda(λ): Ưu tiên MERA. Lambda cao hơn sẽ tránh các node pin yếu mạnh mẽ hơn.

-gamma(γ): Discount factor (hệ số chiết khấu) của Q-learning. Gamma cao hơn nghĩa là coi trọng reward trong tương lai hơn.
